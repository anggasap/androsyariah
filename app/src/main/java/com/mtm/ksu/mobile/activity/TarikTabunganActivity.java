...
public class TarikTabunganActivity extends Activity implements
        OnClickListener, OnItemClickListener, RekeningListTaskListener,TransactionTaskListener {
    final Context context = this;
    final TarikTabunganActivity transactionTaskListener = this;
    ...
    private void showKonfirmasiTransaksi() {
        ...
        if (!validate()) {
            String message = "No. Rekening, Nama Nasabah dan Jumlah Penarikan Tidak Boleh Kosong !";
            ...
            if (!"".equals(jumlahPembayaranText.getText().toString())) {
                ...
                LayoutInflater factory = LayoutInflater
                        .from(TarikTabunganActivity.this);
                konfirmasiDialog = new AlertDialog.Builder(
                        TarikTabunganActivity.this).create();
                ...
                setorTabunganListener = new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        progressDialog = ProgressDialog.show(context, "",
                                "Processing...");
                        String URLSetorTabunganAction = Constants.HTTP_SERVER_SERVICE + ActionConstants.REKENING_SERVICE_TARIK_TABUNGAN;
                        ...
                        request.setKodeTrans(SharedPrefMgr.getKodeTransTarik());
                ...
                konfirmasiDialog.setTitle("Konfirmasi Tarik Tabungan");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        ((TarikTabunganActivity) context).alertDialogStores.cancel();
    }
    ...
    public void onTransactionComplete(Transaction data) {
        ...
        request.setTanggalTrans(SharedPrefMgr.getTanggalOperasional());
        request.setTipeTrans(Constants.PRINTING_TRANS_TYPE_TARIK_TABUNGAN);
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            if(!hasFocus){
                if("".equals(jumlahPembayaranText.getText().toString())){
                    ...
                    double saldoAkhir = saldoTabFmt - jumlahSetoranFmt ;
                    String saldoAkhirFmt = nf.format(saldoAkhir);
                    saldoTabAftText.setText(saldoAkhirFmt);
                }else{
                    NumberFormat nf = NumberFormat.getInstance();
