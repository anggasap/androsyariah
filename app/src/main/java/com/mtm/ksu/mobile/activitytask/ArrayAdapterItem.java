...
public class ArrayAdapterItem extends ArrayAdapter<Rekening> {
    ...
    public ArrayAdapterItem(Context mContext, int layoutResourceId, List<Rekening> itemsArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        */
        ...
        TextView saldoView = (TextView)rowView.findViewById(R.id.textViewSaldo);
		...
		String saldo = itemsArrayList.get(position).getSaldo();
		String jumlahSaldoFmt = nf.format(Double
				.parseDouble(saldo));
		saldoView.setText(jumlahSaldoFmt);
